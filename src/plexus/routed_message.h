...
public:
   ...
   */
  RoutingOptions &setDeliverVia(LinkPtr link) { deliverVia = link; return *this; }
public:
  /// Force delivery over a specific link
  LinkWeakPtr deliverVia;
};
...
public:
  ...
  /**
   * Returns the originator link pointer. When the originator is null, this
   * means that the message has been generated by the local node.
   */
  inline LinkWeakPtr originator() const { return m_originator; }
...
private:
  ...
  /// Pointer to originator link
  LinkWeakPtr m_originator;
  /// Routing options
